  ...
  if (scroll) {
    return (
      <Scroll
        ...
        activeClass="active"
        className={cn(
          'flex w-full max-w-[240px] cursor-pointer items-center gap-3 rounded-sm border-2 border-solid p-[10px] text-lg',
          className,
          !disabled && {
      ...
      <a
        className={cn(
          ...
          !disabled && {
            ['justify-center border-primary bg-primary text-white_light duration-300 hover:bg-hover focus:bg-hover']:
              variant == 'primary',
            ['justify-center border-white_light bg-white_light text-primary duration-300 hover:bg-blue_light']:
              variant == 'secondary',
            ['justify-center border-primary bg-transparent text-primary duration-300 hover:bg-blue_light  focus:bg-blue_light ']:
              variant == 'ghost',
            ['max-w-auto justify-start border-none bg-transparent px-0 text-dark duration-300 hover:text-primary']:
              variant == 'simple',
          },
