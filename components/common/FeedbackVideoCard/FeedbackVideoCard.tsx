...
import PlayVideoIcon from '@/public/images/feedback/play-icon.svg';
import HoverPlayVideoIcon from '@/public/images/feedback/play-icon-1.svg';
...
export const FeedbackVideoCard: FC<FeedbackVideoCardProps> = ({
  ...
  return (
    <li {...props}>
      <div className="gradient relative h-full w-full text-white_light">
        {hasWindow && (
          <ReactPlayer
            url={author.url}
            height="100%"
            ...
            light={
              <Image
                src={author.photoDefault || '/default-image.jpg'}
                alt="Thumbnail"
